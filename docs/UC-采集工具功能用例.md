...
| 查看信息 | 查看工具基础信息和状态 |
| 编辑工具 | 根据类型进入对应编辑器（表单设计器/访谈提纲设计器/检查清单设计器），问卷类型跳转第三方系统 |
| 发布 | 发布后可在项目中使用 |
| 取消发布 | 恢复可编辑状态 |
| 删除 | 删除未发布的工具 |
...
- 采集工具 ←→ 指标体系（间接）：采集工具字段 → 要素 → 数据指标，通过要素建立数据链路
...
>
> **满意度统计**：可通过派生要素实现满意度计算，如创建公式 `满意问卷数 / 回收问卷总数 * 100` 计算满意率。
...
**1. 单行文本 (text)**
| 属性分类 | 属性 | 类型 | 必填 | 输入限制 | 说明 |
|----------|------|------|:----:|----------|------|
| 基础属性 | 字段ID | string | - | 自动生成 | 系统自动生成，只读 |
| | 标签 | string | ✓ | 1-50字符 | 字段显示名称 |
| | 占位符 | string | | 0-100字符 | 输入框提示文字 |
| | 帮助文本 | string | | 0-200字符 | 字段说明 |
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填 |
| 高级设置 | 最大长度 | number | | 1-10000 | 最大输入字符数 |
| | 正则校验 | string | | 有效正则表达式 | 自定义正则表达式 |
| | 校验提示 | string | | 0-100字符 | 校验失败提示语 |
| | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填 |
| 高级设置 | 最大长度 | number | | 1-50000 | 最大输入字符数 |
| | 行数 | number | | 1-20 | 显示行数（默认3行） |
| | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填 |
| 数值设置 | 小数位数 | enum | | 固定选项 | 整数 / 1位 / 2位 / 3位 / 4位 |
| | 最小值 | number | | -999999999~999999999 | 数值下限 |
| | 最大值 | number | | -999999999~999999999 | 数值上限，需≥最小值 |
| | 单位 | string | | 0-10字符 | 如：个、人、元、% |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| 基础属性 | 字段ID | string | - | 自动生成 | 系统自动生成，只读 |
| | 标签 | string | ✓ | 1-50字符 | 字段显示名称 |
| | 占位符 | string | | 0-50字符 | 如"请选择" |
| | 帮助文本 | string | | 0-200字符 | 字段说明 |
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填 |
| 选项配置 | 选项列表 | array | ✓ | 1-100项，label≤50字符 | [{label, value}] 格式 |
| | 支持搜索 | boolean | | true/false | 选项多时启用搜索 |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| | 帮助文本 | string | | 0-200字符 | 字段说明 |
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填（至少选一项） |
| 选项配置 | 选项列表 | array | ✓ | 2-50项，label≤50字符 | [{label, value}] 格式 |
| | 选项布局 | enum | | 固定选项 | vertical（垂直）/ horizontal（水平） |
| | 最少选择 | number | | 0~选项数 | 最少选择项数 |
| | 最多选择 | number | | ≥最少选择 | 最多选择项数 |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| 选项配置 | 选项列表 | array | ✓ | 2-50项，label≤50字符 | [{label, value}] 格式 |
| | 选项布局 | enum | | 固定选项 | vertical（垂直）/ horizontal（水平） |
| | 默认值 | string | | 选项value之一 | 默认选中项的value |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| 基础属性 | 字段ID | string | - | 自动生成 | 系统自动生成，只读 |
| | 标签 | string | ✓ | 1-50字符 | 字段显示名称 |
| | 占位符 | string | | 0-50字符 | 如"请选择日期" |
| | 帮助文本 | string | | 0-200字符 | 字段说明 |
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填 |
| 高级设置 | 日期格式 | enum | | 固定选项 | YYYY-MM-DD / YYYY/MM/DD / YYYY年MM月DD日 |
| | 最早日期 | string | | YYYY-MM-DD格式 | 可选择的最早日期 |
| | 最晚日期 | string | | YYYY-MM-DD格式，≥最早日期 | 可选择的最晚日期 |
| | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| 基础属性 | 字段ID | string | - | 自动生成 | 系统自动生成，只读 |
| | 标签 | string | ✓ | 1-50字符 | 字段显示名称 |
| | 占位符 | string | | 0-50字符 | 如"请选择时间" |
| | 帮助文本 | string | | 0-200字符 | 字段说明 |
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填 |
| 高级设置 | 时间格式 | enum | | 固定选项 | HH:mm / HH:mm:ss |
| | 分钟步长 | number | | 1/5/10/15/30/60 | 如 15 表示每15分钟一档 |
| | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| | 必填 | boolean | | true/false | 是否必填 |
| 上传设置 | 文件类型 | array | | 扩展名格式，如.pdf | 允许的文件扩展名，如 [".pdf", ".doc", ".jpg"] |
| | 最大文件数 | number | | 1-20 | 最多上传文件数（默认1） |
| | 单文件大小限制 | number | | 1-100 (MB) | 单个文件最大MB数 |
| | 上传提示 | string | | 0-100字符 | 如"支持PDF、Word格式，单文件不超过10MB" |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
| | 帮助文本 | string | | 0-200字符 | 字段说明 |
| | 宽度 | enum | | 固定选项 | 25% / 33% / 50% / 75% / 100% |
| 开关设置 | 开启文字 | string | | 0-10字符 | 开启状态显示文字，如"是" |
| | 关闭文字 | string | | 0-10字符 | 关闭状态显示文字，如"否" |
| | 默认值 | boolean | | true/false | 默认开关状态 |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
| | 动态标签 | array | | JSON数组 | labelWhen 规则 |
...
|----------|------|------|:----:|----------|------|
| 基础属性 | 字段ID | string | - | 自动生成 | 系统自动生成，只读 |
| | 标题 | string | | 0-50字符 | 分割线标题文字（可选） |
| 样式设置 | 线条样式 | enum | | 固定选项 | solid（实线）/ dashed（虚线） |
| | 标题位置 | enum | | 固定选项 | left / center / right |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
...
|----------|------|------|:----:|----------|------|
| 基础属性 | 字段ID | string | - | 自动生成 | 系统自动生成，只读 |
| | 分组标题 | string | ✓ | 1-50字符 | 分组显示名称 |
| | 分组说明 | string | | 0-200字符 | 分组描述文字 |
| 样式设置 | 边框样式 | enum | | 固定选项 | bordered（有边框）/ plain（无边框） |
| | 默认展开 | boolean | | true/false | 是否默认展开 |
| | 可折叠 | boolean | | true/false | 是否可折叠 |
| 高级设置 | 条件显示 | object | | JSON格式 | showWhen 规则 |
...
| | 帮助文本 | string | | 0-200字符 | 字段说明 |
| | 宽度 | enum | | 固定100% | 固定100% |
| | 必填 | boolean | | true/false | 是否必须添加至少一条 |
| 列表设置 | 最少条目 | number | | 0-100 | 最少添加条数 |
| | 最多条目 | number | | 1-100，≥最少条目 | 最多添加条数 |
| | 显示模式 | enum | | 固定选项 | table（表格）/ card（卡片） |
| | 表头配置 | array | | 与子字段数匹配 | 表格模式的列标题 |
| 子字段配置 | 子字段列表 | array | ✓ | 1-10个子字段 | 每条记录包含的字段定义 |
...
│  │                                                                         │ │
│  │  ┌──────────────┬──────────────┬──────────────┬──────────┬────────┐   │ │
│  │  │   荣誉名称   │   获得时间   │   授予单位   │   级别   │  操作  │   │ │
│  │  ├──────────────┼──────────────┼──────────────┼──────────┼────────┤   │ │
│  │  │ 示范性学校   │ 2024-09-01   │ 市教育局     │ 市级     │ 🗑️    │   │ │
│  │  ├──────────────┼──────────────┼──────────────┼──────────┼────────┤   │ │
│  │  │ 文明校园     │ 2023-12-15   │ 区文明办     │ 区县级   │ 🗑️    │   │ │
│  │  └──────────────┴──────────────┴──────────────┴──────────┴────────┘   │ │
│  │                                                                         │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
...
| 属性 | 类型 | 必填 | 输入限制 | 说明 |
|------|------|:----:|----------|------|
| 维度名称 | string | ✓ | 1-50字符 | 如"发展战略"、"教学实践" |
| 维度说明 | string | | 0-200字符 | 该维度的访谈目的说明 |
| 排序 | number | | 自动生成 | 维度显示顺序 |

*问题属性：*
| 属性 | 类型 | 必填 | 输入限制 | 说明 |
|------|------|:----:|----------|------|
| 问题内容 | string | ✓ | 1-500字符 | 访谈问题的具体表述 |
| 关键要点 | string | | 0-200字符 | 回答中应关注的核心要点，逗号分隔 |
| 追问提示 | string | | 0-200字符 | 可选的追问方向，帮助深入了解 |
| 是否必问 | enum | ✓ | 固定选项 | 必问 / 选问 |
| 问题类型 | enum | ✓ | 固定选项 | 开放题 / 封闭题 |
| 排序 | number | | 自动生成 | 问题显示顺序 |
...
│  访谈主题：学校发展战略与办学理念访谈                                        │
│  访谈对象：校长                     预计时长：45 分钟                        │
│  访谈说明：了解学校发展思路和管理创新情况，掌握学校办学理念和特色建设进展    │
│                                                                              │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  一、发展战略                                                                │
│                                                                              │
│  1. 请介绍学校的发展定位和中长期规划？                              [必问]  │
│     ┌────────────────────────────────────────────────────────────────────┐  │
│     │ 关键要点：办学目标、发展愿景、阶段规划                              │  │
│     │ 追问提示：规划制定过程、师生参与度、实施进展                        │  │
│     └────────────────────────────────────────────────────────────────────┘  │
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  访谈人：_______________    记录人：_______________    日期：_______________│
│                                                                              │
│  总体印象与补充说明：                                                        │
...
| 属性 | 类型 | 必填 | 输入限制 | 说明 |
|------|------|:----:|----------|------|
| 类别名称 | string | ✓ | 1-50字符 | 如"消防设施"、"实验室安全" |
| 类别说明 | string | | 0-200字符 | 该类别的检查目的说明 |
| 排序 | number | | 自动生成 | 类别显示顺序 |

*检查项属性：*
| 属性 | 类型 | 必填 | 输入限制 | 说明 |
|------|------|:----:|----------|------|
| 检查项名称 | string | ✓ | 1-100字符 | 检查项的简短名称 |
| 达标标准 | string | ✓ | 1-500字符 | 详细描述达标的具体要求 |
| 判定选项 | enum[] | ✓ | 至少选2项 | 可选的判定结果，默认：达标/不达标/部分达标 |
| 支持不适用 | boolean | | true/false | 是否包含"不适用"选项 |
| 是否必查 | enum | ✓ | 固定选项 | 必查 / 选查 |
| 需要拍照 | boolean | | true/false | 是否要求拍照取证 |
| 最少照片数 | number | | 1-10 | 需拍照时，最少上传照片数 |
| 排序 | number | | 自动生成 | 检查项显示顺序 |
