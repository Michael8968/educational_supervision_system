...
指标体系是评估项目的核心框架，定义评估维度、指标和达标标准。

| 类型 | 说明 |
|------|------|
| 达标类 | 每项指标设置达标阈值，统计达标率 |
| 评分类 | 每项指标设置权重，加权计算总分 |

> **拷贝机制**：项目创建时完整拷贝所选指标体系的快照，与原始指标体系解耦。
>
> 详细功能用例请参阅：[UC-指标体系库功能用例](./UC-指标体系库功能用例.md)
...
> **拷贝机制**：项目创建时完整拷贝所选要素库的快照，与原始要素库解耦。
>
> 详细功能用例请参阅：[UC-要素库功能用例](./UC-要素库功能用例.md)

**采集工具库**

采集工具是数据收集的载体，用于定义数据采集的字段和逻辑。

| 类型 | 说明 | 编辑方式 |
|------|------|----------|
| 表单 | 结构化数据采集 | 本地可视化表单设计器 |
| 问卷 | 问卷调查采集 | 第三方问卷系统 |
| 访谈 | 访谈提纲采集 | 访谈提纲设计器 |
| 现场查验 | 检查清单采集 | 检查清单设计器 |

> **引用机制**：项目级采集工具通过引用方式使用采集工具库，库工具变更会影响已关联的项目。
>
> 详细功能用例请参阅：[UC-采集工具功能用例](./UC-采集工具功能用例.md)
