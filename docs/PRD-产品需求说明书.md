...
| 关键字搜索 | 输入框 | 按名称模糊搜索 |
| 状态筛选 | 下拉单选 | 全部状态 / 草稿 / 编辑中 / 已发布 |
| 类型筛选 | 下拉单选 | 全部类型 / 表单 / 问卷 / 访谈 / 现场查验 |

**列表项展示：**
| 信息 | 说明 |
|------|------|
| 名称 | 工具名称，可点击查看详情 |
| 类型标签 | 表单（蓝色）/ 问卷（绿色）/ 访谈（橙色）/ 现场查验（紫色） |
| 填报对象标签 | 如"填报对象: 学校"（青色） |
| 描述 | 工具描述（截断显示） |
| 创建/更新信息 | 时间和用户 |
| 状态 | 草稿 / 编辑中 / 已发布 |
...
| 草稿/编辑中 | 访谈 | 工具信息、编辑工具、发布、删除 |
| 草稿/编辑中 | 现场查验 | 工具信息、编辑工具、发布、删除 |
| 已发布 | 表单 | 工具信息、编辑工具、取消发布 |
| 已发布 | 问卷 | 工具信息、编辑工具、取消发布 |
| 已发布 | 访谈 | 工具信息、编辑工具、取消发布 |
| 已发布 | 现场查验 | 工具信息、编辑工具、取消发布 |
