...
export const preschoolStatisticsRouter: Router = preschoolStatisticsJs.router;
export const setPreschoolStatisticsDb: (db: Database) => void = preschoolStatisticsJs.setDb;
